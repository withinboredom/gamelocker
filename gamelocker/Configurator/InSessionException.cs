...
namespace Configurator
{
    ...
    public class InSessionException : Exception
    {
        //
        ...
        public InSessionException(string message) : base(message) { }
        public InSessionException(string message, Exception inner) : base(message, inner) { }
        protected InSessionException(
